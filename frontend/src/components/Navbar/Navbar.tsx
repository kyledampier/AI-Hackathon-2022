    ...
    return (
        <Flex bg='#212427' justifyContent='center'>
            <Flex bg="#212427" height="96px" padding="6px 12px" align="center" width="100%" maxWidth='1250px' minWidth="360px">
                ...
                <Button onClick={() => setAuthModalState({open: true, view: 'login'})} mr={6} height="42px" pl={5} pr={5} ml={10} bgColor="#6185EE" color="white" _hover={{bgColor: '#616aee'}} fontWeight={800}>Sign In</Button>
            </Flex>
        </Flex>
    )
}
