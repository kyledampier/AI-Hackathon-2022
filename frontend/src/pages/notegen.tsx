...
const NoteGenerator: NextPage = () => {
    ...
    const getAnalogy = async (article: string) => {
        const request = await fetch(`http://localhost:8080/notes`, {
            method: 'POST',
    ...
    const onSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        getAnalogy(analogyForm.article).then(response => {
      ...
      <Flex mb={0} ml={1} mr={1} border="2px solid #38393E" flexDirection="column" pt={8} pl={10} pr={10} bg="#202125" height="780px" borderRadius="15px">
            ...
            <Flex p={0} borderRadius="12px" border="2px solid #38393E" flexDirection="column" height="700px" bg="#2B2C31">
                ...
                <Flex ml={2} mr={1} mt={6} mb={6} flexDir="column" pr={3} flexDirection="row" width="100%">
                    <Text ml={10} mr={10} fontWeight={800} color="white" fontSize="13pt">Given a body of text, this widget generates a PDF of guided notes</Text>
                </Flex>
                <form onSubmit={onSubmit}>
                    <Flex mb={7} flexDirection="row" ml={10} mr={10}>
                        <Flex flexDirection="column" border="2px solid #38393E" pt={2} pl={5} pr={5} borderRadius="10px" mr={5} height="400px" width="50%" bg="#202125">
                            ...
                            <Textarea onChange={onChange} mb={5} name="article"  _placeholder={{ color: "#55586b" }} color="white" bg="#202125" required height="300px" _focus={{ border: "1.5px solid #616aee" }} isDisabled={false} placeholder='Text goes here' />
                        </Flex>
                        <Flex  flexDirection="column" pt={5} pl={5} pr={5} border="2px solid #38393E" borderRadius="10px" ml={5} height="400px" width="50%" bg="#202125">
                            <Text mb={4} fontWeight={800} fontSize="14pt" color="white">Notes Generated</Text>
